...
export default class Notes extends Component {
  ...
  getNote() {
    return API.get("learn-notes", `/notes/${this.props.match.params.id}`);
  }
  ...
  saveNote(note) {
    return API.put("learn-notes", `/notes/${this.props.match.params.id}`, {
      body: note,
    });
  }
  ...
  deleteNote() {
    return API.del("learn-notes", `/notes/${this.props.match.params.id}`);
  }
